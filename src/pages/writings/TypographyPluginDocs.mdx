...
<a href="https://play.tailwindcss.com/uj1vGACRJA?layout=preview">
	<img
		src={'https://tailwindcss.com/_next/static/media/typography-demo.e7148517.jpg'}
...
````html
To learn about customizing the included type scales, read the documentation on [customizing the
CSS](#customizing-the-css). ### Adapting to dark mode Each default color theme includes a
hand-designed dark mode version that you can trigger by adding the `prose-invert` class: ```html
